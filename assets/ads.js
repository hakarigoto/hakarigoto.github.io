...
(function () {
  ...
  var ADS = {
    ...
    /* ▼ マナー電卓(冠婚葬祭) */
    /* 2026-09-23 Sol判断: 葬儀案件が承認されても、この空文字を埋めるだけで
       自動的に広告を復活させない。掲載するときは、その時点で各ページの
       検索意図と配置位置を再審査してから枠を置く。
       /manner/mochu-bunrei/ の2枠は同日に撤去済み(年賀状スクエアのカードと
       合わせて広告密度が急増するため)。残る4ページ(koden / kibiki /
       blog/koden-kakikata / blog/tsuya-fukuso)も同様に要再審査。 */
