...
(function () {
  ...
  var OFFERS = {
    ...
    lifeReset: {
      ...
      headline: "急ぎの遺品整理を最短即日で依頼したい人向け",
      summary: "遺品整理・生前整理の受付サービス。全国の加盟店が対応し、最短即日・土日祝の対応をうたっています(遺品整理110番は複数業者の紹介・見積比較型で役割が異なります)。",
      recommendedFor: ["急ぎで対応してほしい(退去期限など)", "生前整理も含めて相談したい", "土日祝に対応してほしい"],
      notRecommendedFor: ["複数業者の見積をじっくり比較したい場合(紹介型サービスの方が適します)", "実際の作業は加盟店が行うため、対応・料金の詳細は見積時の確認が必要です"],
      feeText: "見積は無料",
      areaText: "対応地域は公式サイトで確認",
      resultTypes: ["estate-cleanup"],
    ...
    happinessPet: {
      ...
      summary: "出張訪問型のペット火葬サービス。火葬料金7,700円(税込)〜と料金が公式サイトに明示されており、WEB・電話の問い合わせから見積もりを取れます。",
      ...
      feeText: "火葬料金7,700円(税込)〜(体重・プランで変動・2026年9月改定)",
    ...
    matsui: {
      ...
      destinationUrl: "https://h.accesstrade.net/sp/cc?rk=0100efx900oypr",
      impressionHtml: '<img src="https://h.accesstrade.net/sp/rr?rk=0100efx900oypr" width="1" height="1" style="border:none;" loading="lazy" alt="">',
    ...
    nengaSquare: {
      ...
      notRecommendedFor: ["宛名印刷の無料は、デザイン面への印刷と同時に宛名を印刷する会員向けの条件があります", "はがき代が料金に含まれるかは公式サイトでご確認ください", "投函代行については、当サイト確認時点では公式サイト上で明確な案内を確認できませんでした。必要な場合は注文前に公式サイトでご確認ください"],
